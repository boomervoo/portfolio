...
export function Cases() {
  ...
  return (
    <section
      id="cases"
      className="pb-[2rem] rounded-xl scroll-mt-[70px] w-full"
    >
      <h2 className="uppercase text-2xl pl-[2rem] font-semibold mb-4">
        Мои Кейсы
      </h2>
      <CasesSlider
        className="2xl:max-w-[85rem] mb-10 xl:max-w-[70rem] md:max-w-[50rem]"
